...
/**
 * It was copied from the original package edu.stanford.nlp.parser.lexparser and brought local to have some specific
 * behaviors changed to be able to binarize the tree even without any lexical tag.
 *
 * The original notes:
 *
 ...
 */
public class TreeBinarizerLocal implements TreeTransformer {
    ...
    public Tree transformTree(Tree t) {
        ...
        // handle categories
        String oldTreeLabel = t.label().value();
        t.label().setValue("ROOT");
        Tree headChild = hf.determineHead(t);
        t.label().setValue(oldTreeLabel);
    /*
...
//      CategoryWordTag headLabel = (CategoryWordTag) headChild.label();
     ...
     */
    public TreeBinarizerLocal(HeadFinder hf, TreebankLanguagePack tlp,
